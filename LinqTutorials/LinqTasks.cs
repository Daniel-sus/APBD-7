    ...
    public static class LinqTasks
    {
        ...
        public static Emp Task9()
        {
            Emp result = Emps
                ...
                .First(emp => emp.Job == "Frontend programmer");
            return result;
        }
        ...
        public static IEnumerable<object> Task10()
        {
            IEnumerable<object> result = Emps
                ...
                .Union(
                    Enumerable.Repeat(new { Ename = "Brak wartości", Job = "", Hiredate = DateTime.MinValue }, 1),
                    new EmpComparer()
                );
            return result;
        }

        public class EmpComparer : IEqualityComparer<object>
        {
            public new bool Equals(object x, object y)
            {
                ...
                return emp1.Ename == emp2.Ename && emp1.Job == emp2.Job && emp1.HireDate == emp2.HireDate;
            }

            public int GetHashCode(object obj)
            {
                var emp = obj as Emp;
                return emp == null ? 0 : emp.GetHashCode();
            }
        }
        ...
        public static IEnumerable<object> Task11()
        {
            IEnumerable<object> result = Emps
                ...
                .Select(group => new
                { name = Depts.First(dept => dept.Deptno == group.Key).Dname, numOfEmployees = group.Count() });
            return result;
        }
        ...
        {
            IEnumerable<object> result = Emps
                .Join(Depts, emp => 1, dept => 1, (emp, dept) => new { emp, dept });
            return result;
        }
    }
